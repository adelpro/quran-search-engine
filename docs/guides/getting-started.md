...
1. Start by picking your package manager in the [Installation Guide](./installation.md).
2. Grab the basic setup block in [Quick Start](./quick-start.md).
3. If you want a deep dive into how scores are assigned across Arabic morphology, read [Search Syntax](./search-syntax.md).
4. See live implementations like a React or Angular frontend under [Examples](./examples.md).
